  ...
  <article class="sheet">
    ...
    <main class="content">
      <section class="summary">
        ...
        <div class="stat"><div class="label">Абонемент</div><div class="value">${escapeHtml(data.subscription || "—")}</div></div>
      ...
      <section class="two-col">
        ...
        <div class="section">
          <h2>Следующий шаг</h2>
          ${textBlock(data.nextStep || data.plan, "Следующий шаг преподаватель добавит в отчёт.")}
        </div>
      </section>
      ...
      <section class="section">
        <h2>Итог</h2>
        <p>В отчёте видно ${escapeHtml(completedLessons)} проведённых занятий, ${escapeHtml(doneItems)} выполненных материалов или тренировок и текущий учебный фокус. Это рабочая картина прогресса без лишней канцелярщины: что делаем, зачем делаем и куда идём дальше.</p>
      </section>
    </main>
