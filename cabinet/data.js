...
window.NGE_DATA = {
  ...
  "students": [
    ...
    },
    {
      ...
      "subscription_month": "2026-05",
      "lessons_used_this_month": 3,
      "stability_note": "Май-июнь абонемент 8 уроков (4 вт + 4 вс) до 14.06.2026. Старт 19.05.2026. С 14.06 — летний пересбор. Проведено 3 из 8. История: 26.04, 3.05, 10.05 cancelled (согласованные), 17.05 missed (без предупреждения).",
      "payment_status": "Оплачено",
      ...
      "lessons": [
        ...
        { "date": "2026-05-31", "num": 4, "status": "planned", "topic": "Jerusalem — A City of Three Faiths (speaking-focus, Would, Modals)", "homework": { "module_url": "https://newgeneration-english.ru/lingua-boost-lab/b1/jerusalem-three-faiths/", "module_title": "Открыть урок Jerusalem", "text": "Интерактивный B1-урок: 17 секций, аудио, говорение, Would-конструкции, модальные глаголы. Можно открыть до занятия — пробежаться по vocabulary, дать ушам привыкнуть к narrator-аудио." } },
