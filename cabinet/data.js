  ...
  "students": [
    {
      ...
      "lessons": [
        ...
        { "date": "2026-06-30", "num": 9, "status": "planned", "topic": "Летняя контрольная встреча #1 — разбор июньской серии заданий" },
        { "date": "2026-07-30", "num": 10, "status": "planned", "topic": "Летняя контрольная встреча #2 — разбор июльской серии заданий" },
        { "date": "2026-08-27", "num": 11, "status": "planned", "topic": "Летняя контрольная встреча #3 — настройка на сентябрь, финальный разбор" }
      ]
    },
    {
      "id": "sova-elena",
    ...
    },
    {
      ...
      "lessons": [
        ...
        { "date": "2026-06-09", "num": 2, "status": "planned", "topic": "Voyager L2 · Are we alone? (Drake equation, Fermi paradox — формат как L1)", "schedule_note": "дата уточняется — согласовываем за неделю" },
