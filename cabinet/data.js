  ...
  "students": [
    {
      ...
      "stability_note": "Актуализировано 20.05.2026: остаётся 3 урока до летних каникул — 27.05 (вт), 29.05 (чт), 02.06 (вт = перенос чт-формата). После 02.06 уходит на каникулы до сентября 2026, с высылкой ему форм.",
      ...
      "lessons": [
        ...
        { "date": "2026-05-19", "num": 5, "status": "completed", "topic": "TOEFL по темам — наука, нейробиология, полимеры (повторение блока)" },
    ...
    },
    {
      ...
      "lessons": [
        ...
        { "date": "2026-05-19", "num": 1, "status": "completed", "topic": "Еда + ОГЭ-формат (старт 8-урочного абонемента, оплата поурочно)" },
