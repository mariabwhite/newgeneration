...
ew Generation English\nРћС‚С‡С‘С‚ СѓС‡РµРЅРёРєР°: ${studentName}\nР”Р°С‚Р° РІС‹РіСЂСѓР·РєРё: ${generatedLabel}`;
  ...
  return builder({
    title: "Личный отчёт ученика",
    studentName,
    generatedLabel,
    level: progress?.level || "—",
    subscription: "Учебный трек",
    totalLessons: lessons.length,
    lessonsLeft: events.length,
    focus: progress?.goals || progress?.comments || "Продолжаем идти по учебному плану и отмечать выполненную практику.",
    body: [
    ...
    nextStep: progress?.studentGoals || progress?.goals || "Открыть ближайшие материалы и закрыть практику по плану.",
