    const levels = [
      ...
      },
      {
            ...
            "desc": "Past simple, past continuous, sequence words, comparatives, prepositions of time and place, simple modals вЂ” first-person diary narrative.",
            "reading": {
                  "title": "Yesterday was a strange day",
                  "text": "Yesterday was a strange day, but in the end it became one of my favourites in months. It started badly. My alarm did not work, so I woke up at half past eight instead of seven. I ran to the kitchen, drank cold coffee from the morning before, and left the flat without breakfast. Of course, the lift was being repaired, so I walked down nine floors.\n\nOn the way to the bus stop I realised that I had left my phone at home. I had no map, no music, no messages вЂ” just twenty minutes of walking in silence. At first this felt uncomfortable. Then I noticed small things I usually miss: an old bakery on a corner, two cats in a window, a man playing the violin near the metro.\n\nOf course, I was late for work. My boss was understanding because the lift incident is famous in our building. After lunch a colleague asked if I wanted to walk home with her вЂ” she had also forgotten her phone. We talked the whole way. In the end, the day without screens turned out to be the best one of the week.",
                  "questions": [
                        { "text": "What time did the narrator wake up?", "options": ["At seven.", "At half past eight.", "At nine."], "answer": 1 },
                        { "text": "Why did the narrator walk down nine floors?", "options": ["For exercise.", "The lift was being repaired.", "The narrator was late."], "answer": 1 },
                        { "text": "What did the narrator forget at home?", "options": ["A phone.", "A bag.", "A coat."], "answer": 0 },
                        { "text": "How did the silence feel at first?", "options": ["Peaceful.", "Uncomfortable.", "Funny."], "answer": 1 },
                        { "text": "Which detail does the narrator notice on the way?", "options": ["A man playing the violin near the metro.", "A new shop opening.", "A traffic accident."], "answer": 0 },
                        { "text": "Why was the boss understanding?", "options": ["The boss was also late.", "The lift incident is famous in the building.", "The narrator brought coffee."], "answer": 1 },
                        { "text": "What had happened to the colleague?", "options": ["She also forgot her phone.", "She quit her job.", "She missed the bus."], "answer": 0 },
                        { "text": "What is the main idea of the story?", "options": ["A day that started badly but turned out to be the best of the week.", "A normal Tuesday.", "A trip to another city."], "answer": 0 }
                  ]
            },
            "listening": {
                  "title": "A voice note about yesterday",
                  "script": "Hi, it's me. Just sending you a quick voice note because typing this would take forever. So, you know I had that crazy day yesterday? It just kept going. Imagine: I get to the office, finally, after walking down nine floors and forgetting my phone, and there's a meeting starting in five minutes. My boss looks at me, does not say anything, just smiles. Apparently everyone has a story about that lift.\n\nThen around three, a colleague вЂ” Marina, you do not know her вЂ” asks if I am walking home. She is also without her phone, can you believe it? Two of us, in 2026, without phones. We walked through the park, talked about everything: her divorce, my new flat, why we hate Tuesdays. By the time I got home I felt better than I had in weeks.\n\nAnyway, that is it. Call me when you are free. And maybe try a day without your phone, seriously. I think you would like it.",
                  "questions": [
      ...
      },
      {
            ...
            "desc": "Present perfect (duration), past perfect, used to, modals of speculation, comparatives, relative clauses, reported speech вЂ” magazine feature about an unusual urban hobby.",
            "reading": {
                  "title": "Urban beekeepers: the quiet new craft of the city",
                  "text": "Until ten years ago, the words city and beekeeping did not naturally belong in the same sentence. Bees were imagined on quiet farms or in mountain villages, not on the rooftops of office buildings in Moscow, Berlin or Tokyo. Yet today, urban beekeeping is one of the fastest growing small hobbies in European and Russian capitals, and many of those involved would tell you that they have never been happier.\n\nThe case for urban beekeeping is partly environmental. Cities, surprisingly, often have richer flowering than the countryside, where monoculture farms produce vast fields of a single crop. A modern city block can host fifty different plant species in a small area, which means urban bees often produce more diverse, more interesting honey than their rural cousins. Bee numbers in the countryside have declined sharply since the 1990s; in some cities, they have actually grown.\n\nThe other reason is harder to measure. People who have spent a year or two with their first hive often describe the same change: a slower attention, a willingness to be patient, a sense that they are part of something older than office life. One Moscow beekeeper, formerly a marketing manager, said that she used to check her email every two minutes; now she can spend an hour just watching the entrance of a hive.\n\nCritics point out that the trend is not without problems. Urban beekeepers need training; without it, hives can become a nuisance to neighbours or even a health risk. But the same critics admit that, when done responsibly, urban beekeeping offers something the modern city often lacks: a slower relationship with living things, and a small, useful, weekly responsibility that does not involve a screen.",
                  "questions": [
                        { "text": "Until ten years ago, where were bees normally imagined?", "options": ["On rooftops in capitals.", "On quiet farms or in mountain villages.", "In office buildings."], "answer": 1 },
                        { "text": "Why do cities sometimes have richer flowering than the countryside?", "options": ["Because cities are warmer.", "Because monoculture farms produce vast fields of a single crop.", "Because cities have more rain."], "answer": 1 },
                        { "text": "What has happened to bee numbers in the countryside since the 1990s?", "options": ["They have grown.", "They have declined sharply.", "They have stayed the same."], "answer": 1 },
                        { "text": "What kind of honey do urban bees often produce?", "options": ["Sweeter but less interesting.", "More diverse and more interesting.", "Identical to rural honey."], "answer": 1 },
                        { "text": "What change do new beekeepers often describe?", "options": ["Faster work and louder evenings.", "Slower attention and more patience.", "Quick financial success."], "answer": 1 },
                        { "text": "What was the Moscow beekeeper's previous profession?", "options": ["Lawyer.", "Marketing manager.", "Teacher."], "answer": 1 },
                        { "text": "What is the risk mentioned by critics?", "options": ["Bees may escape and damage cars.", "Hives can become a nuisance to neighbours or a health risk without training.", "Honey may become too expensive."], "answer": 1 },
                        { "text": "According to the text, what does urban beekeeping offer that the modern city lacks?", "options": ["A guaranteed second income.", "A slower relationship with living things and a weekly responsibility without a screen.", "A new professional title."], "answer": 1 }
                  ]
            },
            "listening": {
                  "title": "Podcast interview: City Things, with urban beekeeper Olga",
                  "script": "Host: Welcome back to City Things. Today we are talking to Olga, who has been an urban beekeeper in Moscow for almost six years. Olga, thank you for joining us. Many of our listeners are surprised that beekeeping is even possible in a city.\nOlga: I understand the surprise. When I started in 2020, my own family thought I was joking. But honestly, the bees do not care that they are in Moscow. They care about flowers, water and a calm hive entrance. All three are available on a rooftop near the Garden Ring.\nHost: What was the hardest part of the first year?\nOlga: Two things. The first was technical вЂ” I had read several books, but books cannot show you how a swarm sounds at six in the morning. The second was social. Some neighbours were nervous about the bees. I learned to talk to them carefully, to invite them up, to show that the hive was calm. After two seasons, no one complained.\nHost: And what surprised you most?\nOlga: That the bees changed me more than I changed the rooftop. I used to think faster was always better. Now I think faster is sometimes just louder. Beekeeping teaches you to slow down without becoming passive.",
                  "questions": [
            ...
            "speaking": "Record 2 minutes. Talk about a hobby or activity that has surprised you вЂ” your own or someone else's. Explain how it started, what was difficult at first, and how it has changed your view of useful or important time.",
            "grammar": [
      ...
      },
      {
            ...
            "reading": {
                  "title": "The epidemic of loneliness: a useful word or a misleading one?",
                  "text": "When the United States Surgeon General Vivek Murthy issued a public advisory titled Our Epidemic of Loneliness and Isolation in 2023, he made a striking comparison: the health risks of chronic loneliness, he said, are comparable to those of smoking fifteen cigarettes a day. The phrasing was deliberate. It was meant to signal that loneliness is no longer a soft emotional complaint; it is a population-level public health concern. The United Kingdom had already drawn a similar conclusion: in 2018 it appointed a Minister for Loneliness, and Japan followed in 2021.\n\nThe numbers behind these announcements are unsettling. In the United States, time spent in face-to-face social contact fell from roughly six and a half hours per week in 2003 to fewer than four hours by 2020. Among Americans aged fifteen to twenty-four, the decline was even sharper. The pattern is not unique to America. Similar trends appear, with national variations, across most wealthy societies. The paradox is hard to ignore: the most digitally connected generation in history is also, by self-report, the most isolated.\n\nYet describing this as an epidemic carries its own dangers. The metaphor encourages a clinical framing. If loneliness is an illness, then it has carriers, symptoms and, presumably, treatments. From there it is a short step to prescribing pills, apps and self-help routines. Pharmaceutical companies have already noticed. So have technology firms, who now offer chatbot companions and AI-driven loneliness reduction subscriptions.\n\nThe clinical framing is not entirely wrong. Chronic loneliness does correlate with measurable physiological harm вЂ” elevated inflammation, poorer sleep, accelerated cognitive decline. But focusing on the individual sufferer risks obscuring something more structural. Cities have been redesigned around private transport, public spaces have shrunk, work has migrated home, and many of the institutions that once produced incidental social contact вЂ” local libraries, neighbourhood clubs, parish associations, even bus queues вЂ” have either disappeared or been thinned out. None of this is solved by a self-care app.\n\nThe most useful interventions tend to be quietly unglamorous. They include investment in third places where people gather without spending money, better urban planning around walkability, support for community-led initiatives, and policies that protect the time and energy people need for sustained relationships. None of these will earn anyone a Nobel Prize. They are, however, more likely to reduce loneliness than any pill or chatbot вЂ” because they treat the conditions that produce it, rather than the symptoms it produces.",
                  "questions": [
                        { "text": "What comparison did Vivek Murthy use in 2023 to describe the health risks of chronic loneliness?", "options": ["Comparable to smoking fifteen cigarettes a day.", "Comparable to mild obesity.", "Comparable to skipping breakfast."], "answer": 0 },
                        { "text": "What did the United Kingdom do in 2018?", "options": ["It appointed a Minister for Loneliness.", "It closed all parish associations.", "It banned chatbot companions."], "answer": 0 },
                        { "text": "How did weekly face-to-face social contact change in the United States between 2003 and 2020?", "options": ["It rose from four to six and a half hours.", "It fell from roughly six and a half hours to fewer than four.", "It stayed the same."], "answer": 1 },
                        { "text": "What does the writer call hard to ignore?", "options": ["The cost of new technology.", "The paradox that the most digitally connected generation is also the most isolated.", "The popularity of self-help books."], "answer": 1 },
                        { "text": "What does the writer say the epidemic metaphor encourages?", "options": ["A clinical framing.", "An ecological framing.", "A purely literary reading."], "answer": 0 },
                        { "text": "Why is the writer critical of focusing on the individual sufferer?", "options": ["Because individuals are dishonest.", "Because it risks obscuring something more structural.", "Because therapists are expensive."], "answer": 1 },
                        { "text": "Which examples of disappearing institutions does the writer give?", "options": ["Hospitals and police stations.", "Local libraries, neighbourhood clubs, parish associations, even bus queues.", "Cinemas and concert halls."], "answer": 1 },
                        { "text": "What kind of interventions does the writer favour?", "options": ["Pills and AI chatbots.", "Self-care apps and online courses.", "Third places, walkable cities, community-led initiatives, time-protective policies."], "answer": 2 }
                  ]
            },
            "listening": {
                  "title": "Lecture: the diagnostic temptation in social commentary",
                  "script": "In today's lecture I want to focus on what I will call the diagnostic temptation in social commentary. The case I will use is the recent discussion of loneliness as an epidemic.\n\nThe vocabulary of epidemic is unusually powerful. It moves a problem from the realm of personal misfortune into the realm of public health, which means budgets, agencies and policy. That is often useful. The 2023 Surgeon General advisory in the United States, for instance, would have attracted very little attention if it had used softer language. By choosing the word epidemic, it secured a level of seriousness that purely sociological framings rarely achieve.\n\nHowever, the same vocabulary can mislead. An epidemic implies a pathogen, a vector and individual cases. Loneliness, when examined carefully, behaves more like an ecological condition than a contagion. It emerges from the way cities are built, from how working hours have shifted, from which institutions have been allowed to weaken. It is not transmitted; it is produced.\n\nThis distinction matters because the two framings recommend very different interventions. A pathological framing favours individualised responses: therapy, medication, perhaps an app. An ecological framing favours structural responses: walkable neighbourhoods, public libraries, time-protective labour laws. Both can coexist, but they are not equivalent.\n\nThe deeper question вЂ” and this is where I want you to push beyond conventional readings вЂ” is who benefits from each framing. Clinical and technological interventions are easier to monetise and easier to study. Structural interventions are slower, less visible and politically uncomfortable, because they imply that current city design, current labour culture, and current public spending priorities have been quietly producing the very condition they now claim to treat.\n\nI am not suggesting that individual treatment is useless. I am suggesting that, taken in isolation, it acts as a kind of moral comfort. It allows societies to be seen to be doing something about loneliness without changing the structures that produce it. That, I would argue, is precisely the conservatism of a diagnostic vocabulary applied to a structural problem.",
                  "questions": [
                        ...
                        { "text": "What is the lecturer's main warning about individual treatment in isolation?", "options": ["That it acts as a kind of moral comfort вЂ” appearing to do something without changing the structures.", "That it is harmful in every case.", "That it should be banned."], "answer": 0 }
                  ]
            },
    ...
    function audioPath(level) {
      return `assets/diagnostic-audio/${level.code}-listening.mp3`;
    }
